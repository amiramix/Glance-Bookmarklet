...
function create_spritz(){
    spritz_loader = function() {
        //getURL("https://rawgithub.com/rko/OpenSpritz/master/spritz.html", function(data){

        //getURL("https://rawgithub.com/rko/OpenSpritz/dev/spritz.html", function(data){

        // This won't work in Firefox because an old bug and won't work in
        ...
        var commit = "9e92c605032be16c986ed699d68e0acd3534e6b1";
        getURL("https://cdn.rawgit.com/rko/OpenSpritz/" + commit + "/spritz.html", function(data){
